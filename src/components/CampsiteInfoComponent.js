                    ...
                    <ModalBody>
                        <LocalForm onSubmit={(values => this.handleModal(values))}>
                            ...
                            <div className="form-group">
                                ...
                                <Control.text model=".author" name="author" className="form-control" id="author" placeholder="Your Name" validators={{
                            ...
                            <div className="form-group">
                                ...
                                <Control.textarea model=".text" name="text" className="form-control" id="text" rows="6"
                                />
                            </div>
                            <div className="form-group">
